...
hb6_amazon = hb6.filterBounds(hb3_amazon.geometry().buffer(-500))
...
for x in range(0,len(hbID)):
    ...
    # THIS LINE FAILS sometimes. sometimes need to simplify geometries or use
    # other spatial filtering method
